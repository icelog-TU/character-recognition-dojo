...
|---|---|---|---|---|---|---|---|---|---|
| L185 | 像 / normal lesson | ready-blocked-by-dependency | Production B | codex/l185-complete-package / recheck-commit-pending | L184:課 | ["課"] | curriculum-workflow/lesson-requests/L185.json; curriculum-workflow/generated/L185-generation-packet.md; curriculum-workflow/drafts/L185-draft.json | public/assets/lessons/L185/images/; public/assets/lessons/L185/audio/ | complete package prepared; production JSON not updated because origin/main is currently complete through L183 話 and missing L184 |
