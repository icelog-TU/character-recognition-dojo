...
| L112 | 棒 | claimed | Codex | `codex/l112-bang-assets` / local claim pending | L106:分, L107:幾, L108:點, L109:玩, L110:打, L111:球 | 分, 幾, 點, 玩, 打, 球 | `curriculum-workflow/lesson-requests/L112.json`; `curriculum-workflow/generated/L112-generation-packet.md`; `curriculum-workflow/drafts/L112-draft.json` | `curriculum-workflow/audio-inbox/L112/`; `public/assets/lessons/L112/` | L112 sentence 2 uses 分, so L106 is recorded as an indirect provisional dependency; branch-only until L106-L111 enter production. |
