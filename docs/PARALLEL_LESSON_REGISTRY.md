...
|---|---|---|---|---|---|---|---|---|---|
| L376 | 已 | claimed | Package Rescue | codex/l376-l380-package-rescue | R045/R046; prior numbered lessons | see owned draft | curriculum-workflow/lesson-requests/L376.json; curriculum-workflow/drafts/L376-draft.json; curriculum-workflow/generated/L376-generation-packet.md | public/assets/lessons/L376/; curriculum-workflow/audio-inbox/L376/ | Rescue source 7846e3a33bff4ee87886bb1bd20fbbe89a41037a; audio/timing/QA in progress. Release owns integration. |
| L377 | 近 | claimed | Package Rescue | codex/l376-l380-package-rescue | R045/R046; prior numbered lessons | see owned draft | curriculum-workflow/lesson-requests/L377.json; curriculum-workflow/drafts/L377-draft.json; curriculum-workflow/generated/L377-generation-packet.md | public/assets/lessons/L377/; curriculum-workflow/audio-inbox/L377/ | Rescue source e56d09eca03baf24defaa0dbe91bd360cb6ccb8f; audio/timing/QA in progress. Release owns integration. |
| L378 | 接 | claimed | Package Rescue | codex/l376-l380-package-rescue | R045/R046; prior numbered lessons | see owned draft | curriculum-workflow/lesson-requests/L378.json; curriculum-workflow/drafts/L378-draft.json; curriculum-workflow/generated/L378-generation-packet.md | public/assets/lessons/L378/; curriculum-workflow/audio-inbox/L378/ | Rescue source 2a10a3cffa0d1deec19c85a5d543b3be617317ea; audio/timing/QA in progress. Release owns integration. |
| L379 | 送 | claimed | Package Rescue | codex/l376-l380-package-rescue | R045/R046; prior numbered lessons | see owned draft | curriculum-workflow/lesson-requests/L379.json; curriculum-workflow/drafts/L379-draft.json; curriculum-workflow/generated/L379-generation-packet.md | public/assets/lessons/L379/; curriculum-workflow/audio-inbox/L379/ | Rescue source 22a5dfd6ab3a4283753eb0d86b0545313385b828; audio/timing/QA in progress. Release owns integration. |
| L380 | 連 | claimed | Package Rescue | codex/l376-l380-package-rescue | R045/R046; prior numbered lessons | see owned draft | curriculum-workflow/lesson-requests/L380.json; curriculum-workflow/drafts/L380-draft.json; curriculum-workflow/generated/L380-generation-packet.md | public/assets/lessons/L380/; curriculum-workflow/audio-inbox/L380/ | Rescue source 2d213e7b5d8db921e05630bb86708442fb2e7316; audio/timing/QA in progress. Release owns integration. |
...
- Starting after L045, every 15-lesson milestone gets two review modules. Example: after L045, R001/R002 must ship before L046 enters `main`; after L060, R003/R004 must ship before L061 enters `main`.
- Do not merge a later lesson while any `Depends On` row is not merged. This is a Release/main rule, not a Production-start rule. Production may prepare later lesson packages in parallel when the dependency is recorded and teacher-approved.
