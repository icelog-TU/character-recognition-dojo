...
|---|---|---|---|---|---|---|---|---|---|
| L135 | 喝 / normal lesson | assets | Codex production thread | `codex/l135-complete-package` / pending | merged through L134 | none | `curriculum-workflow/lesson-requests/L135.json`; `curriculum-workflow/generated/L135-generation-packet.md`; `curriculum-workflow/drafts/L135-draft.json` | `curriculum-workflow/audio-inbox/L135/`; `public/assets/lessons/L135/` | Complete request/packet/aligned draft/images/audio package prepared; production JSON, planner, and ledger intentionally left to ordered release lane. |
