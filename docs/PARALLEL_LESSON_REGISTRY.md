...
|---|---|---|---|---|---|---|---|---|---|
| L105 | 過 | ready-blocked-by-dependency | Codex / L105 production assets thread | `codex/l105-guo-assets` / `326d5d7` | L103:難, L104:得 | none | `curriculum-workflow/lesson-requests/L105.json`; `curriculum-workflow/generated/L105-generation-packet.md`; `curriculum-workflow/drafts/L105-draft.json` | `curriculum-workflow/audio-inbox/L105/`; `public/assets/lessons/L105/` | Production-ready parallel prep is complete. Latest `origin/main` contains L104; L105 still needs ordered merge/recheck before later lessons can merge. |
| L106 | 分 | ready-blocked-by-dependency | Codex / L106 production assets thread | `codex/l106-fen-assets` / `ebae623` | L101:圓, L102:太, L103:難, L104:得, L105:過 | 過 | `curriculum-workflow/lesson-requests/L106.json`; `curriculum-workflow/generated/L106-generation-packet.md`; `curriculum-workflow/drafts/L106-draft.json` | `curriculum-workflow/audio-inbox/L106/`; `public/assets/lessons/L106/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Latest `origin/main` contains L104; blocked until L105 is merged into latest `origin/main`; do not merge production JSON yet. |
| L107 | 幾 | ready-blocked-by-dependency | Codex / L107 production assets thread | `codex/l107-ji-assets` / `a151865` | L102:太, L103:難, L104:得, L105:過, L106:分 | 過 分 | `curriculum-workflow/lesson-requests/L107.json`; `curriculum-workflow/generated/L107-generation-packet.md`; `curriculum-workflow/drafts/L107-draft.json` | `curriculum-workflow/audio-inbox/L107/`; `public/assets/lessons/L107/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Latest `origin/main` contains L104; blocked until L105 and L106 are merged into latest `origin/main`; do not merge production JSON yet. |
| L108 | 點 | ready-blocked-by-dependency | Codex / L108 production assets thread | `codex/l108-dian-assets` / `4f8ea1f` | L103:難, L104:得, L105:過, L106:分, L107:幾 | 過 分 幾 | `curriculum-workflow/lesson-requests/L108.json`; `curriculum-workflow/generated/L108-generation-packet.md`; `curriculum-workflow/drafts/L108-draft.json` | `curriculum-workflow/audio-inbox/L108/`; `public/assets/lessons/L108/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Latest `origin/main` contains L104; blocked until L105, L106, and L107 are merged into latest `origin/main`; do not merge production JSON yet. |
| L109 | 玩 | claimed | Codex / L109 production assets thread | `codex/l109-wan-assets` / `2cd6c6e` | L104:得, L105:過, L106:分, L107:幾, L108:點 | 過 分 幾 點 | `curriculum-workflow/lesson-requests/L109.json`; `curriculum-workflow/generated/L109-generation-packet.md`; `curriculum-workflow/drafts/L109-draft.json` | `curriculum-workflow/audio-inbox/L109/`; `public/assets/lessons/L109/` | Teacher-approved sentence set supplied in a separate thread. Branch currently has claim only; blocked until L105-L108 are merged into latest `origin/main`; do not merge production JSON yet. |
| L110 | 打 | ready-blocked-by-dependency | Codex / L110 production assets thread | `codex/l110-da-assets` / `local assets commit pending` | L105:過, L106:分, L107:幾, L108:點, L109:玩 | 過 分 幾 點 玩 | `curriculum-workflow/lesson-requests/L110.json`; `curriculum-workflow/generated/L110-generation-packet.md`; `curriculum-workflow/drafts/L110-draft.json` | `curriculum-workflow/audio-inbox/L110/`; `public/assets/lessons/L110/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Latest `origin/main` contains L104; blocked until L105-L109 are merged into latest `origin/main`; do not merge production JSON yet. |
