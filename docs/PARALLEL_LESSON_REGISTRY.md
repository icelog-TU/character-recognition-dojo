...
|---|---|---|---|---|---|---|---|---|---|
| L370 | 朋友 / two-character word lesson pilot | asset-complete-package | Production B | codex/l370-complete-package | None | None | curriculum-workflow/lesson-requests/L370.json; curriculum-workflow/generated/L370-generation-packet.md; curriculum-workflow/drafts/L370-draft.json | public/assets/lessons/L370/; curriculum-workflow/audio-inbox/L370/ | Five WebP images and eleven processed M4A assets; local technical gates passed. Teacher confirmed G02 prefix and G05 wrong-one; fingerprint evidence recorded. Browser G02 recording/replay completion not observed; technical fallback documented in packet. Teacher override: Stage 2 duplicate-card behavior will be verified post-merge on main during first two-character pilot. Do not block package completion on pre-merge Stage 2 card-count simulation. |
