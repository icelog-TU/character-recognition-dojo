...
|---|---|---|---|---|---|---|---|---|---|
| L330 | 角 / normal lesson | ready-blocked-by-dependency | Production B | codex/l330-complete-package | L328; L329 | 轉; 右 | `curriculum-workflow/lesson-requests/L330.json`; `curriculum-workflow/generated/L330-generation-packet.md`; `curriculum-workflow/drafts/L330-draft.json` | `public/assets/lessons/L330/`; `curriculum-workflow/audio-inbox/L330/` | Asset-complete package built; blocked until L328 and L329 are integrated; Release owns ordered integration. |
