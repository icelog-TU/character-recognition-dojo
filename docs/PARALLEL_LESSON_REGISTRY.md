...
| L119 | 空 | ready-blocked-by-dependency | Codex / L119 assets thread | `codex/l119-kong-assets` / pending asset commit | L112:棒, L113:頭, L114:帽, L115:草, L116:地, L117:面, L118:外 | 棒, 頭, 帽, 草, 地, 面, 外 | `curriculum-workflow/lesson-requests/L119.json`; `curriculum-workflow/generated/L119-generation-packet.md` | `curriculum-workflow/drafts/L119-draft.json`; `public/assets/lessons/L119/` | Production assets prepared on branch; blocked until L112-L118 are merged and rechecked. User direct dependencies are L114-L118; L112-L113 are listed for ordered release. |
