...
|---|---|---|---|---|---|---|---|---|---|
| L213 | 游 / normal lesson | ready-blocked-by-dependency | Production A | codex/l213-complete-package / pending final commit | L211:船, L212:魚 | ["船","魚"] | curriculum-workflow/lesson-requests/L213.json; curriculum-workflow/generated/L213-generation-packet.md; curriculum-workflow/drafts/L213-draft.json | public/assets/lessons/L213/images/; public/assets/lessons/L213/audio/ | asset-complete package; blocked until L211-L212 enter origin/main; Release owns production JSON, planner, ledger, registry cleanup, final verify, merge, and deploy |
