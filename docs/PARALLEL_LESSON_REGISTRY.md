...
|---|---|---|---|---|---|---|---|---|---|
| L407 | 減 | dependency-blocked-asset-complete | Production A | codex/l407-complete-package | L405:越; L406:加 | 越加 | curriculum-workflow/lesson-requests/L407.json; curriculum-workflow/generated/L407-generation-packet.md; curriculum-workflow/drafts/L407-draft.json | curriculum-workflow/audio-inbox/L407/; public/assets/lessons/L407/ | Five WebP, ten M4A, nine timing records, technical and browser QA PASS. Main recheck 2632d2c3. After405 R049:awaiting Release; R050:awaiting Release. Teacher subjective review post-main. No readable text or number exception. |
