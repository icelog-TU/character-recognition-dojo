...
|---|---|---|---|---|---|---|---|---|---|
| L167 | 又 / normal lesson | claimed | Production A | codex/l167-complete-package / e8daca8 | L165:先, L166:洗 | 先, 洗 | `curriculum-workflow/lesson-requests/L167.json`, `curriculum-workflow/generated/L167-generation-packet.md` | `public/assets/lessons/L167/images/`, `public/assets/lessons/L167/audio/` | accepted handoff and starting complete package |
