...
|---|---|---|---|---|---|---|---|---|---|
| L120 | 天 | ready-blocked-by-dependency | Codex / L120 assets thread | `codex/l120-tian-assets` / `aa724e9` | L112:棒, L113:頭, L114:帽, L115:草, L116:地, L117:面, L118:外, L119:空 | 棒, 頭, 帽, 草, 地, 面, 外, 空 | `curriculum-workflow/lesson-requests/L120.json`; `curriculum-workflow/generated/L120-generation-packet.md` | `curriculum-workflow/drafts/L120-draft.json`; `curriculum-workflow/audio-inbox/L120/`; `public/assets/lessons/L120/` | Branch-only assets prepared; waiting for L112-L119 to merge before production JSON. User direct dependencies are L115-L119; L112-L114 are ordered release-lane dependencies. Temporary production insertion was removed. |
