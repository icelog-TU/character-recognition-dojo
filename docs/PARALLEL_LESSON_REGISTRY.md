...
|---|---|---|---|---|---|---|---|---|---|
| L132 | 套 | ready-blocked-by-dependency | Codex L132 assets thread | `codex/l132-tao-assets` / `4c7e26f` | L127-L131 not merged in `origin/main` | L127 穿, L128 戴, L129 衣, L130 脫, L131 氣, L132 套 | none; teacher supplied final sentence text in chat | `public/assets/lessons/L132/`, `curriculum-workflow/audio-inbox/L132/` | Images and sentence/character audio prepared only. Production JSON intentionally unchanged until dependencies are merged in order. |
