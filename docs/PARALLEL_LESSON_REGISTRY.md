...
|---|---|---|---|---|---|---|---|---|---|
| R057 | 複習五十七 | ready-blocked-by-dependency | Production F | `codex/r057-r058-complete-package` | L462:日; L463:期; L464:待; L465:招 | 日、期、待、招 | `curriculum-workflow/review-requests/R057.json`; `curriculum-workflow/generated/R057-generation-packet.md`; `curriculum-workflow/drafts/R057-draft.json` | `public/assets/reviews/R057/`; `curriculum-workflow/audio-inbox/R057/` | dependency-blocked-asset-complete: 5 WebP + 9 M4A, transcript/timing and style/cast QA PASS; Release integrates L462-L465 first, then R057 before R058. |
| R058 | 複習五十八 | ready-blocked-by-dependency | Production F | `codex/r057-r058-complete-package` | L462:日; L463:期; L464:待; L465:招; paired after R057 | 日、期、待、招 | `curriculum-workflow/review-requests/R058.json`; `curriculum-workflow/generated/R058-generation-packet.md`; `curriculum-workflow/drafts/R058-draft.json` | `public/assets/reviews/R058/`; `curriculum-workflow/audio-inbox/R058/` | dependency-blocked-asset-complete: authoritative R058-S02 mistaken-identity package only; all prior archery content absent. 5 WebP + 9 M4A and QA complete; Release integrates after R057. |
