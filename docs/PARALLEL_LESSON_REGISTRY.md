...
|---|---|---|---|---|---|---|---|---|---|
| L477 | 緣 | request-ready | Production F / parallel-f | `codex/l477-complete-package` | L472:案; L473:反; L474:而; L475:且; L476:故; R057/R058 after L465 | 案、反、而、且、故 | `curriculum-workflow/lesson-requests/L477.json`; `curriculum-workflow/generated/L477-generation-packet.md`; `curriculum-workflow/drafts/L477-draft.json` | `public/assets/lessons/L477/`; `curriculum-workflow/audio-inbox/L477/` | Teacher-approved request, packet and draft created. Vocabulary ceiling locked to formal L001-L465 plus five provisional dependency characters and 緣: 475 unique Han; allowed sweep, coverage and Stage 4 indexes PASS. |
