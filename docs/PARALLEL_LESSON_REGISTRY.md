...
|---|---|---|---|---|---|---|---|---|---|
| L367 | 謝 | ready-blocked-by-dependency | Production C | codex/l367-complete-package (assets 2695f970; final tip on branch) | L366 | 吧 | curriculum-workflow/lesson-requests/L367.json; curriculum-workflow/generated/L367-generation-packet.md; curriculum-workflow/drafts/L367-draft.json | public/assets/lessons/L367/; curriculum-workflow/audio-inbox/L367/ | dependency-blocked-asset-complete; pushed package-intake PASS; 5 WebP, 9 M4A, all referenced timings and technical gates PASS. L366 blocks Release only. Browser local-media tooling limitation documented; teacher review is post-main. |
