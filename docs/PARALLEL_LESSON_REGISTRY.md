...
| L091 | 子 | claimed | Codex / L091 production assets thread | `codex/l091-zi-assets` / pending | L090:桌, R003, R004 | 桌 | `curriculum-workflow/lesson-requests/L091.json`; `curriculum-workflow/generated/L091-generation-packet.md` | `curriculum-workflow/audio-inbox/L091/`; `public/assets/lessons/L091/` | Parallel prep only until L090 and R003/R004 are merged into latest `origin/main`; do not merge production JSON yet. Single-character audio must be neutral-tone 台灣華語 ㄗ˙, not third tone. |
