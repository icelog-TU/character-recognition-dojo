...
| L103 | 難 | claimed | Codex / L103 production assets thread | `codex/l103-nan-assets` / local claim | L098:鼻, L099:臉, L100:紅, L101:圓, L102:太 | 太 | `curriculum-workflow/lesson-requests/L103.json`; `curriculum-workflow/generated/L103-generation-packet.md`; `curriculum-workflow/drafts/L103-draft.json` | `curriculum-workflow/audio-inbox/L103/`; `public/assets/lessons/L103/` | Teacher-approved sentence set received. Branch-only parallel preparation; blocked until L102 is merged into latest `origin/main`; do not merge production JSON yet. |
