...
|---|---|---|---|---|---|---|---|---|---|
| L368 | 感 | asset-complete-package | Package Rescue | codex/l368-package-rescue | L366 / L367 (merged) | none | curriculum-workflow/lesson-requests/L368.json / curriculum-workflow/generated/L368-generation-packet.md / curriculum-workflow/drafts/L368-draft.json | public/assets/lessons/L368/; curriculum-workflow/audio-inbox/L368/ | Audio/timing rescue complete; see final packet and QA evidence. Release owns integration. Post-merge queue: lesson-asset-review.html?unit=L368&ref=main |
