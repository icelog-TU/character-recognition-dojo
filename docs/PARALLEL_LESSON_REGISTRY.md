...
|---|---|---|---|---|---|---|---|---|---|
| L447 | 拍 | ready-blocked-by-dependency | Production F / `parallel-f` | `codex/l447-complete-package` / `571b49f6` | Text: L442:機, L443:操, L444:器, L445:樂, L446:音; Release order: L439:練, L440:運, L441:賽 | 機、操、器、樂、音 | `curriculum-workflow/lesson-requests/L447.json`; `curriculum-workflow/generated/L447-generation-packet.md`; `curriculum-workflow/drafts/L447-draft.json` | `curriculum-workflow/audio-inbox/L447/`; `public/assets/lessons/L447/` | Formal boundary `origin/main@b594d6a9` is L438:習 (442 learned chars). Allowed vocabulary is locked to that boundary plus 機、操、器、樂、音、拍 (448 chars). Complete lesson-local package: 5 WebPs, 10 M4As, sentence/G02 timings, transcript and style/cast QA. Release waits for L439-L446 in order; browser QA PASS at `571b49f6`; teacher manual image/audio review PASS at `82945397`; normal post-main asset review remains repair queue. |
