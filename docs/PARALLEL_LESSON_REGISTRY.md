...
| L108 | 點 | claimed | Codex / L108 production assets thread | `codex/l108-dian-assets` / `local claim pending` | L103:難, L104:得, L105:過, L106:分, L107:幾 | 過 分 幾 | `curriculum-workflow/lesson-requests/L108.json`; `curriculum-workflow/generated/L108-generation-packet.md`; `curriculum-workflow/drafts/L108-draft.json` | `curriculum-workflow/audio-inbox/L108/`; `public/assets/lessons/L108/` | Teacher-approved sentence set received. Branch-only parallel preparation; latest `origin/main` contains L104, blocked until L105, L106, and L107 are merged into latest `origin/main`; do not merge production JSON yet. |
