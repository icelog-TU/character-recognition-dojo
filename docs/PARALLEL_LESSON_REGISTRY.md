...
|---|---|---|---|---|---|---|---|---|---|
| L251 | 重 / normal lesson | ready-blocked-by-dependency | Production A | codex/l251-complete-package / 9cdf1213 | R013, R014, L241 工, L242 作, L243 忙, L244 幫, L245 急, L246 腳, L247 步, L248 跳, L249 床, L250 搬 | ["工","作","忙","幫","急","腳","步","跳","床","搬"] | curriculum-workflow/lesson-requests/L251.json; curriculum-workflow/generated/L251-generation-packet.md | public/assets/lessons/L251/images/; public/assets/lessons/L251/audio/ | complete package prepared; local validate:production and verify passed; blocked from merge until R013/R014 and L241-L250 are in main; Release owns production JSON integration |
