...
|---|---|---|---|---|---|---|---|---|---|
| L310 | 每 / normal lesson | ready-blocked-by-dependency | Production A | codex/l310-complete-package / package complete | L307 照, L308 顧, L309 忘 | ["照","顧","忘"] | curriculum-workflow/lesson-requests/L310.json, curriculum-workflow/generated/L310-generation-packet.md | public/assets/lessons/L310/images/, public/assets/lessons/L310/audio/ | complete package ready; blocked from production JSON until L307-L309 are in main; G02 target is sentence-initial, so teachAudio uses suffix-only per schema |
