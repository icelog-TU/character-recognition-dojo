...
|---|---|---|---|---|---|---|---|---|---|
| L327 | 直 | ready-blocked-by-dependency | Production C | codex/l327-complete-package | L324:圖; L325:向; L326:線 | 圖 向 線 | curriculum-workflow/lesson-requests/L327.json; curriculum-workflow/generated/L327-generation-packet.md; curriculum-workflow/drafts/L327-draft.json | curriculum-workflow/audio-inbox/L327/; public/assets/lessons/L327/ | Dependency-blocked asset-complete package. Latest origin/main through L323:方; R037/R038 already in main at claim time. L327 local assets passed validate:production and assets:audit while temporarily inserted for asset checks. |
