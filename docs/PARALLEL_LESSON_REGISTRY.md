...
|---|---|---|---|---|---|---|---|---|---|
| L070 | 了 | ready-blocked-by-dependency | Codex L070 thread | codex/l070-le @ aa556d6 | L069:朵 | 朵 | `curriculum-workflow/lesson-requests/L070.json`; `curriculum-workflow/generated/L070-generation-packet.md`; `curriculum-workflow/drafts/L070-draft.json` | `public/assets/lessons/L070/images/`; `public/assets/lessons/L070/audio/` | Teacher approved L070 new char `了` and five final sentences in chat. Images, AI sentence audio, AI-aligned charTimings, and `了` char audio are prepared and pushed. Merge is blocked until L069 enters latest `origin/main`, then rebase and recheck before production. |
| L071 | 畫 | claimed | Codex L071 畫 thread | local shared worktree; no production merge until L069-L070 merge | L069:朵; L070:了 | 朵了 | `curriculum-workflow/lesson-requests/L071.json`; `curriculum-workflow/generated/L071-generation-packet.md`; `curriculum-workflow/drafts/L071-draft.json` | planned `curriculum-workflow/audio-inbox/L071/`; `public/assets/lessons/L071/` | Teacher approved L071 new char `畫` and five final sentences in chat. Prepare assets only; do not merge before L069 and L070 are production truth on latest main. |
| L073 | 出 | claimed | Codex L073 出 thread | codex/l073-chu | L070:了; L071; L072:畫 | 了畫 | `curriculum-workflow/lesson-requests/L073.json`; `curriculum-workflow/generated/L073-generation-packet.md`; `curriculum-workflow/drafts/L073-draft.json` | planned `curriculum-workflow/audio-inbox/L073/`; `public/assets/lessons/L073/` | Teacher approved L073 new char `出` and five final sentences in chat. Prepare assets only; do not merge until L070-L072 enter latest `origin/main`, then rebase and recheck against the real learned-character set. |
