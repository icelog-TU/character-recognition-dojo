...
|---|---|---|---|---|---|---|---|---|---|
| L370 | 朋友 / two-character word lesson pilot | claimed | Production B | codex/l370-complete-package; claim ad7b6b5d | L366, L367, L368, L369 | 吧, 謝, 感, 情 | curriculum-workflow/lesson-requests/L370.json; curriculum-workflow/generated/L370-generation-packet.md; curriculum-workflow/drafts/L370-draft.json | public/assets/lessons/L370/; curriculum-workflow/audio-inbox/L370/ | One normal lesson, order 370; newChars 朋/友; base cd4abf4b1ffe125be5402883a31b3197e1e892cd. Claim only, no assets generated. Pilot app blocker: src/App.tsx makeFindChallenge uses targets directly for multi-character lessons, so 朋 and 友 each appear once. Actual function tested across 100 draws: min=max=1 each; SOP repeated-practice expectation is at least two per character. Both target acceptance paths exist. Stopped per assigned pilot app-defect condition; app owner must repair repeated target generation, then rerun mobile Stage 2 QA before package completion. tools:check, ai:check, curriculum:audit-state passed. Dependency blockers remain Release-only. |
