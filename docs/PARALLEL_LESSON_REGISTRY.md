...
|---|---|---|---|---|---|---|---|---|---|
| L256 | 死 / normal lesson | ready-blocked-by-dependency | Production B | codex/l256-complete-package / pending final commit | L251 重, L252 沙, L253 張, L254 椅, L255 累 | ["重","沙","張","椅","累"] | curriculum-workflow/lesson-requests/L256.json; curriculum-workflow/generated/L256-generation-packet.md | public/assets/lessons/L256/images/; public/assets/lessons/L256/audio/ | complete package prepared; blocked from merge until L251-L255 are in main |
