...
|---|---|---|---|---|---|---|---|---|---|
| L163 | 掃 / normal lesson | claimed | Production B | `codex/l163-complete-package` / `f63bb01` | L159:動; L160:葉; L161:綠; L162:滿 | 動 葉 綠 滿 | `curriculum-workflow/lesson-requests/L163.json`; `curriculum-workflow/generated/L163-generation-packet.md` | `public/assets/lessons/L163/images/`; `public/assets/lessons/L163/audio/` | accepted handoff and starting complete package |
