...
| L107 | 幾 | claimed | Codex / L107 production assets thread | `codex/l107-ji-assets` / local claim | L102:太, L103:難, L104:得, L105:過, L106:分 | 過 分 | `curriculum-workflow/lesson-requests/L107.json`; `curriculum-workflow/generated/L107-generation-packet.md`; `curriculum-workflow/drafts/L107-draft.json` | `curriculum-workflow/audio-inbox/L107/`; `public/assets/lessons/L107/` | Teacher-approved sentence set received. Branch-only parallel preparation; latest `origin/main` contains L104, blocked until L105 and L106 are merged into latest `origin/main`; do not merge production JSON yet. |
