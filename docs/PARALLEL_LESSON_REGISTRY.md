...
|---|---|---|---|---|---|---|---|---|---|
| L449 | 唱 | ready-blocked-by-dependency | Production B | codex/l449-complete-package @ 4cf2d348 | L444, L445, L446, L447, L448 | 器、樂、音、拍、歌 | `curriculum-workflow/lesson-requests/L449.json`; `curriculum-workflow/generated/L449-generation-packet.md`; `curriculum-workflow/drafts/L449-draft.json` | `public/assets/lessons/L449/` | Complete package: 5 WebP, 10 M4A, final sentence and Stage 4 AI alignment. Teacher-directed G02 pronunciation repairs complete; technical gates, immutable browser playback smoke test and image style-lock PASS. L439-L443 remain earlier Release order dependencies but are not used in lesson text. Release owns shared production state. |
