...
|---|---|---|---|---|---|---|---|---|---|
| L147 | 間 / normal lesson | ready-blocked-by-dependency | Production thread B | `codex/l147-complete-package` / pending update | L143:以, L144:怎, L145:所, L146:房 | 以, 怎, 所, 房 | `curriculum-workflow/lesson-requests/L147.json`; `curriculum-workflow/generated/L147-generation-packet.md`; `curriculum-workflow/drafts/L147-draft.json` | `curriculum-workflow/audio-inbox/L147/`; `public/assets/lessons/L147/` | Complete package prepared and teacher audio review passed on 2026-08-07; production JSON remains blocked until L143-L146 enter `origin/main`. Temporary GitHub Pages audio-check page was removed after approval. |
