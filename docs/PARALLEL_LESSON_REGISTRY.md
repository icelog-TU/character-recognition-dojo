...
|---|---|---|---|---|---|---|---|---|---|
| L426 | 輪 | ready-blocked-by-dependency | Remote Production C (teacher reassigned from B); parallel-c | codex/l426-complete-package @ ca4c534ea4a3f5a32ab69dfd570f639946de854a (asset commit) | L421, L422, L423, L424, L425; contiguous L416-L425; R051/R052 after L420 (coverage L391-L420) | 室、班、組、隊、各 | curriculum-workflow/lesson-requests/L426.json; curriculum-workflow/generated/L426-generation-packet.md; curriculum-workflow/drafts/L426-draft.json | public/assets/lessons/L426/; curriculum-workflow/audio-inbox/L426/ | Teacher-approved five sentences; locked source main 4eec5178, 425 allowed chars. Dependencies block Release only; review pair excluded. Package dependency-blocked-asset-complete: 5 WebP, 10 M4A, 9 timed tracks, local gates PASS; pushed package intake PASS at ca4c534ea4a3f5a32ab69dfd570f639946de854a. Browser hold-to-record tooling fallback recorded in production QA. Shared production/planner/ledger left for Release. Post-merge review: https://icelog-tu.github.io/character-recognition-dojo/lesson-asset-review.html (L426); npm run asset:review-status. |
