...
|---|---|---|---|---|---|---|---|---|---|
| L371 | 親 | ready-blocked-by-dependency | Production C | codex/l371-complete-package (assets bf95817a; final tip on branch) | L368,L369,L370 | 感情朋友 | curriculum-workflow/lesson-requests/L371.json; curriculum-workflow/generated/L371-generation-packet.md; curriculum-workflow/drafts/L371-draft.json | public/assets/lessons/L371/; curriculum-workflow/audio-inbox/L371/ | dependency-blocked-asset-complete; pushed intake PASS; 5 WebP, 10 M4A, technical gates PASS. Main 3ee22616 includes L366/L367. L370 word coverage 2; 朋/友 each 3. Browser tooling limitation documented. Prior integration and L370 pilot QA belong to Release. |
