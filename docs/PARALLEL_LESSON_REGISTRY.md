...
|---|---|---|---|---|---|---|---|---|---|
| L150 | 燈 / normal lesson | claimed | Production thread B | `codex/l150-complete-package` / pending | L148:時, L149:還 | 時, 還 | `curriculum-workflow/lesson-requests/L150.json`; `curriculum-workflow/generated/L150-generation-packet.md`; `curriculum-workflow/drafts/L150-draft.json` | `curriculum-workflow/audio-inbox/L150/`; `public/assets/lessons/L150/` | Preparing complete package from teacher-approved handoff. Latest `origin/main` includes L143-L147, so production JSON remains blocked until L148-L149 enter `origin/main`. |
