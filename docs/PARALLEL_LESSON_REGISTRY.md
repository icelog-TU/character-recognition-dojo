...
|---|---|---|---|---|---|---|---|---|---|
| R057 | 複習五十七 | asset-complete-package | Production F | `codex/r057-r058-complete-package` | L462:日; L463:期; L464:待; L465:招 | 日、期、待、招 | `curriculum-workflow/review-requests/R057.json`; `curriculum-workflow/generated/R057-generation-packet.md`; `curriculum-workflow/drafts/R057-draft.json` | `public/assets/reviews/R057/`; `curriculum-workflow/audio-inbox/R057/` | 5 WebP + 9 M4A, transcript/timing, Browser QA and style/cast QA PASS. Final fetch: origin/main `acd71a5b` integrates L462-L465; integrate R057 before R058. R057-S04 teacher repair: equal-height classmates and regenerated ㄊㄧㄠˋ ㄨˇ sentence audio; fixed-ref Browser QA and teacher image/audio review PASS. |
| R058 | 複習五十八 | asset-complete-package | Production F | `codex/r057-r058-complete-package` | L462:日; L463:期; L464:待; L465:招; paired after R057 | 日、期、待、招 | `curriculum-workflow/review-requests/R058.json`; `curriculum-workflow/generated/R058-generation-packet.md`; `curriculum-workflow/drafts/R058-draft.json` | `public/assets/reviews/R058/`; `curriculum-workflow/audio-inbox/R058/` | Authoritative R058-S02 mistaken-identity package only; all prior archery content absent. 5 WebP + 9 M4A and QA complete. Dependencies merged at `acd71a5b`; integrate after R057. Teacher image/audio review PASS at `fc7c8e63`; no R058 issues reported. |
