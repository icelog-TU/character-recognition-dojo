...
|---|---|---|---|---|---|---|---|---|---|
| L153 | 車 / normal lesson | ready-blocked-by-dependency | Production thread B | `codex/l153-complete-package` / `56033c1` | L148:時, L149:還, L150:燈, L151:關, L152:窗 | 時, 還, 燈, 關, 窗 | `curriculum-workflow/lesson-requests/L153.json`; `curriculum-workflow/generated/L153-generation-packet.md`; `curriculum-workflow/drafts/L153-draft.json` | `curriculum-workflow/audio-inbox/L153/`; `public/assets/lessons/L153/` | Complete package prepared from teacher-approved handoff: request, packet, draft, images, sentence audio, charAudio, G02/G05 audio, and AI alignment are done. Production JSON/planner/ledger remain blocked until L148-L152 enter `origin/main`. |
