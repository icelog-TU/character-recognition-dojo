...
|---|---|---|---|---|---|---|---|---|---|
| L447 | 拍 | ready-blocked-by-dependency | Package Rescue / Production F | `codex/l447-package-rescue` | Text: L442:機, L443:操, L444:器, L445:樂, L446:音; Release order: L439:練, L440:運, L441:賽 | 機、操、器、樂、音 | `curriculum-workflow/lesson-requests/L447.json`; `curriculum-workflow/generated/L447-generation-packet.md`; `curriculum-workflow/drafts/L447-draft.json` | `public/assets/lessons/L447/` | Asset complete after Package Rescue. Teacher-approved five texts, five images, nine other audio files, and timings unchanged. Standalone 拍 received volume-only +4 dB gain: mean -30.5 → -26.5 dB, peak -12.0 → -8.1 dB; source waveform retained with PCM correlation 0.9997229984. Release waits for L439-L446 in order. |
