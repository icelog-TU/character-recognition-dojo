...
|---|---|---|---|---|---|---|---|---|---|
| L398 | 選 | dependency-blocked-asset-complete | Production A | codex/l398-complete-package | L393:碼; L394:翻; L395:印; L396:單; L397:雙 | 碼翻印單雙 | curriculum-workflow/lesson-requests/L398.json; curriculum-workflow/generated/L398-generation-packet.md; curriculum-workflow/drafts/L398-draft.json | curriculum-workflow/audio-inbox/L398/; public/assets/lessons/L398/ | 5 WebP, 10 M4A, AI timings, phone/tablet browser PASS. Base L389; Release all preceding lessons and after390 R047/R048 required. S03 red paper/white print; S04 board 3/5/8 only, jersey blank. Teacher review post-main. |
