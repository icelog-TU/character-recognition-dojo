...
|---|---|---|---|---|---|---|---|---|---|
| L336 | 處 | ready-blocked-by-dependency | Production A | codex/l336-complete-package | L335:特 (L334:別 already in main) | 特 | `curriculum-workflow/lesson-requests/L336.json`; `curriculum-workflow/generated/L336-generation-packet.md`; `curriculum-workflow/drafts/L336-draft.json` | `curriculum-workflow/audio-inbox/L336/`; `public/assets/lessons/L336/` | Dependency-blocked asset-complete package prepared from approved handoff; latest main has L334「別」 merged, so only L335「特」 remains provisional. |
