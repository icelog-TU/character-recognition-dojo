...
| L115 | 草 | ready-blocked-by-dependency | Codex / L115 assets thread | `codex/l115-cao-assets` / pending asset commit | L108:點, L109:玩, L110:打, L111:球, L112:棒, L113:頭, L114:帽 | 點, 玩, 打, 球, 棒, 頭, 帽 | `curriculum-workflow/lesson-requests/L115.json`; `curriculum-workflow/generated/L115-generation-packet.md` | `curriculum-workflow/drafts/L115-draft.json`; `curriculum-workflow/audio-inbox/L115/`; `public/assets/lessons/L115/` | L115 branch-only production images, audio, timings, and Stage 4 prepared. User direct dependencies are L110-L114; L108-L109 are listed because the ordered release lane must merge them first. |
