...
|---|---|---|---|---|---|---|---|---|---|
| L301 | 蟲 / normal lesson | ready-blocked-by-review-dependency | Production D | codex/l301-complete-package / 671ba318 | R017, R018 | [] | curriculum-workflow/lesson-requests/L301.json, curriculum-workflow/generated/L301-generation-packet.md | public/assets/lessons/L301/images/, public/assets/lessons/L301/audio/ | complete package prepared; local allowed-character, image, audio, alignment, and production asset audits passed; L301 must not enter production JSON until R017/R018 are in main |
