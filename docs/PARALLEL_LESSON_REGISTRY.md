...
|---|---|---|---|---|---|---|---|---|---|
| L375 | 經 / normal lesson | ready-blocked-by-dependency | Production C | codex/l375-complete-package | L370, L371, L372, L373, L374 | 朋, 友, 親, 交, 通, 往 | curriculum-workflow/lesson-requests/L375.json; curriculum-workflow/generated/L375-generation-packet.md; curriculum-workflow/drafts/L375-draft.json | curriculum-workflow/audio-inbox/L375/; public/assets/lessons/L375/ | dependency-blocked-asset-complete; 5 WebP / 10 M4A, technical QA PASS. Browser local-media tool unavailable; teacher review post-main. L370 word 朋友 is previous-five coverage. R045/R046 follow L375 before L376 release. Shared alignment script changes require Release inspection. |
