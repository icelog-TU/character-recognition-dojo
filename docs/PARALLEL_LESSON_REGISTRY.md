...
|---|---|---|---|---|---|---|---|---|---|
| L295 | 哭 / normal lesson | ready-blocked-by-dependency | Production A | codex/l295-complete-package / package tip pending | L288 受, L289 忍, L290 耐, L291 敢, L292 當, L293 然, L294 怕 | ["受","忍","耐","敢","當","然","怕"] | curriculum-workflow/lesson-requests/L295.json, curriculum-workflow/generated/L295-generation-packet.md | public/assets/lessons/L295/images/, public/assets/lessons/L295/audio/ | complete package ready; blocked until L288-L294 are in main; G02 suffix empty so only prefix teachAudio is referenced |
