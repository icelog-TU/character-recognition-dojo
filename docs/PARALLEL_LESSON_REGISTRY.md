...
| L117 | 面 | claimed | Codex / L117 assets thread | `codex/l117-mian-assets` / `ed352cb` | L110:打, L111:球, L112:棒, L113:頭, L114:帽, L115:草, L116:地 | 打, 球, 棒, 頭, 帽, 草, 地 | `curriculum-workflow/lesson-requests/L117.json`; `curriculum-workflow/generated/L117-generation-packet.md` | `curriculum-workflow/drafts/L117-draft.json`; `curriculum-workflow/audio-inbox/L117/`; `public/assets/lessons/L117/` | Claiming L117 branch-only production assets. User direct dependencies are L112-L116; L111 is also required because approved sentences use 球, and L110 is listed for ordered release. |
