...
|---|---|---|---|---|---|---|---|---|---|
| L349 | 讓 / normal lesson | merge-ready | Production C | codex/l349-complete-package | none | none | `curriculum-workflow/lesson-requests/L349.json`; `curriculum-workflow/generated/L349-generation-packet.md`; `curriculum-workflow/drafts/L349-draft.json` | `curriculum-workflow/audio-inbox/L349/`; `public/assets/lessons/L349/` | Asset-complete package from `origin/main` f9714d19; no provisional dependencies; canonical Stage 4 order used; Release owns production JSON/planner/ledger integration. |
