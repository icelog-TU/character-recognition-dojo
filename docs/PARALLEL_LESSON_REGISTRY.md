...
|---|---|---|---|---|---|---|---|---|---|
| L061 | 坐 | assets | Codex L061 production thread | codex/l061-zuo @ local-assets | none | none | `curriculum-workflow/lesson-requests/L061.json`; `curriculum-workflow/generated/L061-generation-packet.md`; `curriculum-workflow/drafts/L061-draft.json` | `public/assets/lessons/L061/`; `curriculum-workflow/audio-inbox/L061/` | Assets prepared checkpoint. Reviewed images, AI sentence audio, wrong-option audio, AI charTimings, production JSON, ledger, and planner export are prepared; curriculum and production asset validation pass. |
