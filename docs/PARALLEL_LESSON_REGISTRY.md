...
|---|---|---|---|---|---|---|---|---|---|
| L452 | 候 | ready-blocked-by-dependency | Production F / `parallel-f` | `codex/l452-complete-package` / repaired assets `d11aeb2581e9` | Text: L447:拍, L448:歌, L449:唱, L450:舞, L451:台; Release order: L444-L451 and R055/R056 after L450 | 拍、歌、唱、舞、台 | `curriculum-workflow/lesson-requests/L452.json`; `curriculum-workflow/generated/L452-generation-packet.md`; `curriculum-workflow/drafts/L452-draft.json` | `curriculum-workflow/audio-inbox/L452/`; `public/assets/lessons/L452/` | Branch base `origin/main@5622c827` is formally through L443:操. Teacher-approved vocabulary remains locked to `a5779c4b` formal L001-L438 plus 拍、歌、唱、舞、台、候 (448 chars). Complete lesson-local package: 5 WebPs, 10 M4As, sentence/G02 timings, transcript and style/cast QA; fixed-ref Chrome playback 11/11 PASS; teacher-requested S04/S05 image repairs regenerated and fixed-ref preview PASS at `d11aeb2581e9`; teacher approved all five final L452 images on 2026-09-18. Release waits for all listed predecessors and R055/R056; normal post-main asset review remains repair queue. |
