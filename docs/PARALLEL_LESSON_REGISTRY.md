...
|---|---|---|---|---|---|---|---|---|---|
| L059 | 起 | claimed | Codex L059 production thread | codex/l059-production @ 701b679 | none | none | `curriculum-workflow/lesson-requests/L059.json`; `curriculum-workflow/generated/L059-generation-packet.md`; `curriculum-workflow/drafts/L059-draft.json` | `public/assets/lessons/L059/`; `curriculum-workflow/audio-inbox/L059/` | Start / claim checkpoint. Teacher request supplied; S03 focusChar will be corrected from 起 to 比 because the sentence does not contain 起. |
