...
|---|---|---|---|---|---|---|---|---|---|
| L171 | 就 / normal lesson | claimed | Production B | `codex/l171-complete-package` / `dff2627` | L166:洗; L167:又; L168:髒; L169:亂; L170:回 | 洗 又 髒 亂 回 | `curriculum-workflow/lesson-requests/L171.json`; `curriculum-workflow/generated/L171-generation-packet.md` | `public/assets/lessons/L171/images/`; `public/assets/lessons/L171/audio/` | accepted handoff and starting complete package |
