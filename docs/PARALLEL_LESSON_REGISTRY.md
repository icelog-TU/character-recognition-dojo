...
|---|---|---|---|---|---|---|---|---|---|
| L123 | 黑 | ready-blocked-by-dependency | Codex / L123 assets thread | `codex/l123-hei-assets` / `9fa266f` | L112:棒, L113:頭, L114:帽, L115:草, L116:地, L117:面, L118:外, L119:空, L120:天, L121:雨, L122:雲 | 棒, 頭, 帽, 草, 地, 面, 外, 空, 天, 雨, 雲 | `curriculum-workflow/lesson-requests/L123.json`; `curriculum-workflow/generated/L123-generation-packet.md` | `curriculum-workflow/drafts/L123-draft.json`; `curriculum-workflow/audio-inbox/L123/`; `public/assets/lessons/L123/` | L123 branch-only assets prepared; temporary production JSON insertion removed. User direct dependencies are L118-L122; L112-L117 are listed for ordered release before those dependencies. Do not merge production JSON until L112-L122 are merged and rechecked. |
