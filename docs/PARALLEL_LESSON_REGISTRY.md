...
|---|---|---|---|---|---|---|---|---|---|
| L102 | 太 | ready-blocked-by-dependency | Codex / L102 production assets thread | `codex/l102-tai-assets` / `e5251de` | L097:鏡, L098:鼻, L099:臉, L100:紅, L101:圓 | none | `curriculum-workflow/lesson-requests/L102.json`; `curriculum-workflow/generated/L102-generation-packet.md`; `curriculum-workflow/drafts/L102-draft.json` | `curriculum-workflow/audio-inbox/L102/`; `public/assets/lessons/L102/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Latest `origin/main` contains L101; L102 still needs rebase/recheck and ordered merge before L103 can merge. |
| L103 | 難 | ready-blocked-by-dependency | Codex / L103 production assets thread | `codex/l103-nan-assets` / local assets commit pending | L098:鼻, L099:臉, L100:紅, L101:圓, L102:太 | 太 | `curriculum-workflow/lesson-requests/L103.json`; `curriculum-workflow/generated/L103-generation-packet.md`; `curriculum-workflow/drafts/L103-draft.json` | `curriculum-workflow/audio-inbox/L103/`; `public/assets/lessons/L103/` | Request, packet, draft, images, final audio, Stage 4, and AI alignment are prepared branch-only. Blocked until L102 is merged into latest `origin/main`; do not merge production JSON yet. |
