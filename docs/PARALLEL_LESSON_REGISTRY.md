...
|---|---|---|---|---|---|---|---|---|---|
| L094 | 壞 | claimed | Codex / L094 production assets thread | `codex/l094-huai-assets` / pending | L089:把, L090:桌, L091:子, L092:盒, L093:掉 | 把 桌 子 盒 掉 | `curriculum-workflow/lesson-requests/L094.json`; `curriculum-workflow/generated/L094-generation-packet.md` | `curriculum-workflow/audio-inbox/L094/`; `public/assets/lessons/L094/` | Parallel prep only until L089-L093 are merged into latest `origin/main` and R003/R004 remain inserted after L090; do not merge production JSON yet. Teacher-approved target is 壞 ㄏㄨㄞˋ. |
