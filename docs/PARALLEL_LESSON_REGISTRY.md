...
|---|---|---|---|---|---|---|---|---|---|
| L404 | 弱 / normal lesson | claimed | Production B | codex/l404-complete-package | L399, L400, L401, L402, L403; playable predecessors and R047/R048 before Release | 或, 者, 勇, 強, 算 | curriculum-workflow/lesson-requests/L404.json; curriculum-workflow/generated/L404-generation-packet.md; curriculum-workflow/drafts/L404-draft.json | public/assets/lessons/L404/; curriculum-workflow/audio-inbox/L404/ | Base 23cae191, formal L001-L390. S01/S02 continuous story cast; S02 ankle action, no water-fear version. No readable text/numeral exceptions. |
