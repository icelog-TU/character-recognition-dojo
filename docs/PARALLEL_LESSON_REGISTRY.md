...
|---|---|---|---|---|---|---|---|---|---|
| L455 | 現 | claimed | Production C / parallel-c | codex/l455-complete-package | L450-L454; R055/R056 after L450 | 舞、台、候、演、表 | curriculum-workflow/lesson-requests/L455.json; curriculum-workflow/generated/L455-generation-packet.md; curriculum-workflow/drafts/L455-draft.json | public/assets/lessons/L455/ | Teacher-approved five sentences; source main 5622c827; locked 453 allowed chars. Earlier ordinary lessons and the R055/R056 milestone block Release only. |
