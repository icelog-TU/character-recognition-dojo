...
|---|---|---|---|---|---|---|---|---|---|
| L328 | 轉 / normal lesson | merge-ready | Production D | codex/l328-complete-package | none; L324-L327 are in origin/main | [] | curriculum-workflow/lesson-requests/L328.json, curriculum-workflow/generated/L328-generation-packet.md, curriculum-workflow/drafts/L328-draft.json | public/assets/lessons/L328/images/, public/assets/lessons/L328/audio/ | asset-complete package; Release owns production JSON, planner, ledger, and final main integration |
