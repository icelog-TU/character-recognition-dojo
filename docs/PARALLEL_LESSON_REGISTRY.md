...
|---|---|---|---|---|---|---|---|---|---|
| L354 | 排 | partial-package | Production D | codex/l354-complete-package (package tip) | none | none | curriculum-workflow/lesson-requests/L354.json; curriculum-workflow/generated/L354-generation-packet.md; curriculum-workflow/drafts/L354-draft.json | public/assets/lessons/L354/; curriculum-workflow/audio-inbox/L354/ | Base origin/main 71762b03, formal L001-L353. Five images, ten audio files, sentence/Stage 4 alignment and technical audits prepared. Pending mandatory phone playback/highlight/recording QA: browser control unavailable. G05 wrong-one timing smoothing and sentence-tail review need listening confirmation. Not asset-complete or Release-ready. |
