...
- Stage 4 spoken guidance must avoid Mandarin words that browser TTS commonly misreads in this context. For `teach-character`, do not say `請教我念` or `請教牠念`; use unambiguous wording such as `請你幫我念` or `請你幫牠念`.
