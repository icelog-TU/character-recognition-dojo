...
Starting after L060, every 30-lesson milestone gets two review lessons. See `docs/CURRICULUM_OPERATING_SOP.md` for the full cycle.

- After L060: two review lessons, 5 sentences each, must cover every new character from L001-L030 at least once across the 10 sentences.
- After L090: two review lessons, 5 sentences each, must cover every new character from L031-L060 at least once across the 10 sentences.
...
- Plan each two-lesson review pair together. Do not approve the first review lesson if the pair as a whole does not yet cover the required 30-lesson character set.
