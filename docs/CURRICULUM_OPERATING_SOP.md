...
As of latest `origin/main`, production curriculum is complete through L205, L205 introduces `河`, and review modules are complete through R010.

Under the review-blocker rule, there are no overdue review modules at the current L205 boundary. The next required review blockers are R011-R012 after L210.

L001-L005 use the simpler Stage 1-3 flow. L006-L205 already include Stage 4 sentence games after picture-supported sentence listening. Future production lessons should keep Stage 4 unless the teacher explicitly changes the lesson design.
