...
- `docs/ROLE_SUPERVISOR_SOP.md`, `docs/ROLE_EDITOR_SOP.md`, `docs/ROLE_REVIEW_MIGRATION_SOP.md`, `docs/ROLE_REVIEW_MIGRATION_AUDIT_SOP.md`, `docs/ROLE_PRODUCTION_SOP.md`, `docs/ROLE_RELEASE_SOP.md`, and `docs/ROLE_ASSET_REPAIR_SOP.md` are role-specific startup adapters. They must link to the authority files above instead of duplicating detailed rules.
