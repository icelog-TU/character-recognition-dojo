...
As of latest `origin/main`, production curriculum is complete through L184, L184 introduces `課`, and review modules are complete through R010.

Under the review-blocker rule, there are no overdue review modules at the current L184 boundary. The next required review blockers are R011-R012 after L210.
