...
- App name: `認字練功房`
- Current reviewed lessons: L001-L190
- L190 introduces `火`.
- Production review modules: R001-R010.
- Overdue review blockers: none at current L190; next review blockers are R011-R012 after L210.
- L001-L005 use Stage 1-3.
- L006-L190 include Stage 4 fixed sentence games.
