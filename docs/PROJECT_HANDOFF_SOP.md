...
- App name: `認字練功房`
- Current reviewed lessons: L001-L231
- L231 introduces `夠`.
- Production review modules: R001-R012.
- Overdue review blockers: none at L231. Next blockers are R013-R014 after L240, before L241.
- L001-L005 use Stage 1-3.
- L006-L231 include Stage 4 fixed sentence games.
