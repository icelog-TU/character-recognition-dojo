...
- App name: `認字練功房`
- Current reviewed lessons: L001-L019
- L019 introduces `隻` as the measure word read `ㄓ`.
- L001-L005 currently use the simpler three-block flow: listen, find, picture sentence.
- L006-L019 include Stage 4 fixed sentence games after picture-supported listening.
...
L001-L019 are reviewed and built.
L019 introduces `隻` as the measure word read `ㄓ`.
L007 introduces a fixed young girl character for 我.
L012 introduces a fixed second-person young boy character for 你.
L006-L019 include Stage 4 sentence games after picture-supported sentence listening.
