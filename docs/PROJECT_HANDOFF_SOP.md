...
- App name: `認字練功房`
- Current reviewed lessons: L001-L053
- L053 introduces `更`.
- L001-L005 currently use the simpler three-block flow: listen, find, picture sentence.
- L006-L053 include Stage 4 fixed sentence games after picture-supported listening.
...
Lessons use a staged flow. L001-L005 use Stage 1-3. Current production lessons L006-L053 add Stage 4 sentence games after picture-supported sentence listening. Future production lessons should keep Stage 4 unless the teacher explicitly changes the lesson design.
...
L001-L053 are reviewed and built.
L053 introduces `更`.
L007 introduces a fixed young girl character for 我.
L012 introduces a fixed second-person young boy character for 你.
L006-L053 include Stage 4 sentence games after picture-supported sentence listening.
