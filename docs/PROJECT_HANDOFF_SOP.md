...
- Teacher image/audio review is post-merge by default. Automated gates block release; teacher subjective review becomes a repair queue through `public/tools/lesson-asset-review.html`.
