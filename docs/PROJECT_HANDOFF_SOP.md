...
- App name: `認字練功房`
- Current reviewed lessons: L001-L297
- L297 introduces `嚇`.
- Production review modules: R001-R016.
- Overdue review blockers: none at L297; R017-R018 are required after L300 and before L301.
- L001-L005 use Stage 1-3.
- L006-L297 include Stage 4 fixed sentence games.
