...
- 注音：剛=ㄍㄤ
- 目標句數：5
- 教師備註：Approved handoff for Production C. Release resolved lesson dependencies on latest origin/main. Teach 剛 as high-frequency time usage: 剛才, 才剛, 剛生病, 剛放病假, 剛坐下. Use 睡著, not 睡着. Treat 假死 only as a playful dog pretend-dead game; never depict actual death, injury, rescue, sadness, horror, or medical panic.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L262/audio/char-u525b.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
