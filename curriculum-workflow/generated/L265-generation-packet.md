...
- 注音：休=ㄒㄧㄡ
- 目標句數：5
- Release note: L265 was integrated on latest origin/main in playable order; dependencies are resolved. Production JSON, planner data, and ledger are release-owned. Asset review on ref=main is valid after deployment.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L265/audio/char-u4f11.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
