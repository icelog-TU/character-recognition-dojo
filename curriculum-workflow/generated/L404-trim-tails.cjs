...
const root='public/assets/lessons/L404/audio',report=[];
...
fs.writeFileSync('curriculum-workflow/generated/L404-tail-trim-report.json',JSON.stringify(report,null,2)+'\n');console.log(report);
