...
- Teacher notes: Generated from the web next-lesson planner. Selected choice: choice-在. Approved sentences: 水在你小小的手上; 你我二人在水下; 在山下有三個大人; 有山有水，有你有我。; 我在水上，你在水下. Sentence length target: 4-12 Han characters per sentence. Prefer using recent review characters from the previous five lessons: 有 人 山 大 的 小 我 一 個 三 手 上 下 二 你 水. Across this lesson's sentence set, include each new character from the previous three lessons at least once: 下 你 水. Use only learned characters plus the new character(s). Use each sentence's imageNotes as teacher guidance when writing imagePrompt. Generate reviewed image prompts, AI sentence audio, and production AI charTimings after teacher approval.

## Learned Character Boundary

The AI must treat this as a locked curriculum sequence.

- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水
- Current lesson new characters: 在
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在
...
- Image target path pattern: `/assets/lessons/L014/images/L014-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L014/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L014/audio/L014-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L014/audio/L014-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["在"],
  "zhuyin": {"在":"ㄗㄞˋ"},
  "charAudio": {"在":"/assets/lessons/L014/audio/char-在.m4a"},
  "title": "在",
  "requiredRounds": 5,
  "sentences": [
    {
