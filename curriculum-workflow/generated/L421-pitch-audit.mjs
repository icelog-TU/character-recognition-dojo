...
const rows=[];
for(const name of ['L421-S01','L421-S02','char-u5ba4']){
 const raw=execFileSync(ff,['-v','error','-i',`public/assets/lessons/L421/audio/${name}.m4a`,'-ar','16000','-ac','1','-f','f32le','pipe:1'],{maxBuffer:8000000});
...
fs.writeFileSync('curriculum-workflow/generated/L421-pitch-evidence.json',JSON.stringify(rows,null,2)+'\n');
...
svg+='</svg>';fs.writeFileSync('curriculum-workflow/ai-outputs/L421/pitch.svg',svg);
