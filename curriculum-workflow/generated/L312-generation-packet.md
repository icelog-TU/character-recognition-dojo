...
Learner-facing text audited against latest origin/main L001-L311 learned characters plus current ?. Scope: text, spokenText, displayLines, focusChar, and Stage 4 option text. Result: PASS.
...
- L312-G04 partial-order: sentenceId L312-S03, targetChar 照
  missingIndexes [4,5,8,9]; options ["這","次","照","顧"]
