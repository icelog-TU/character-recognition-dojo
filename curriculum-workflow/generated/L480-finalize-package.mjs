...
const productionQA = {
  ...
  pronunciation: 'Independent gpt-audio-1.5 listening against final SHA256 hashes reports exact approved transcripts, natural Taiwan Mandarin, and no omissions/clipping/substitutions or awkward pauses. Confirmed 趣 ㄑㄩˋ, 緣 ㄩㄢˊ, 聊 ㄌㄧㄠˊ, 而 ㄦˊ, 且 ㄑㄧㄝˇ, G02 suffix 的 as neutral tone, and teacher-requested G05 wrong-one 飛不動 with 不 held as a clear falling fourth tone ㄅㄨˋ rather than second tone. Teacher manual pre-merge audio QA PASS at reviewed ref fa9c2427ede6d4153252752ec0241debd0b724f3.',
  ...
  manualPlayback: 'Teacher manual pre-merge asset QA PASS for all L480 images and audio at reviewed ref fa9c2427ede6d4153252752ec0241debd0b724f3: https://icelog-tu.github.io/character-recognition-dojo/tools/lesson-asset-review.html?unit=L480&ref=fa9c2427ede6d4153252752ec0241debd0b724f3',
};
