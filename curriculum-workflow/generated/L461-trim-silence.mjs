...
const root = path.resolve('public/assets/lessons/L461/audio');
const report = [];
...
fs.writeFileSync('curriculum-workflow/generated/L461-silence-trim.json', `${JSON.stringify(report, null, 2)}\n`);
console.log(report);
