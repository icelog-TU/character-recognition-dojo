...
- 注音：假=ㄐㄧㄚˇ
- 目標句數：5
- 教師備註：Production B complete package from approved handoff. Latest origin/main production curriculum is complete through L258. L260 is blocked from production JSON until L259 is in main. 假 is read ㄐㄧㄚˇ in this lesson.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L260/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
