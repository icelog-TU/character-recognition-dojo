...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L216/audio/char-u8eab.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["身"],
  "zhuyin": {"身":"ㄕㄣ"},
  "charAudio": {"身":"/assets/lessons/L216/audio/char-u8eab.m4a"},
  "title": "身",
  "requiredRounds": 5,
  "sentences": [
    {
