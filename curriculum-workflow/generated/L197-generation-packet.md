...
Zhuyin: 陽 ㄧㄤˊ
Title: 陽
Release note: Production package request for L197 陽. Release integrated from latest origin/main complete through L196 亮; former provisional dependency is now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
Release note: Production package request for L197 陽. Release integrated from latest origin/main complete through L196 亮; former provisional dependency is now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
