...
const results = [];
for (const name of ['char-u7fd2', 'L438-G02-suffix']) {
  const file = `public/assets/lessons/L438/audio/${name}.m4a`;
...
fs.writeFileSync('curriculum-workflow/generated/L438-short-audio-audit.json', `${JSON.stringify(results, null, 2)}\n`);
