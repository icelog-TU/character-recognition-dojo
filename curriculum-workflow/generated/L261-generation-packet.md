...
- 注音：才=ㄘㄞˊ
- 目標句數：5
- 教師備註：Approved handoff for Production C. Release resolved dependencies L258-L260 on latest origin/main. Teach 才 mainly as conditional/causal usage; keep S04 as accepted time usage. Use 睡著, not 睡着. Treat 病倒 and 假死 gently; no death, injury, emergency, horror, or medical panic imagery.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L261/audio/char-u624d.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
