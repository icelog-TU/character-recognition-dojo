...
- 注音：亮=ㄌㄧㄤˋ
- 目標句數：5
- Release note: Production package request for L196. Release integrated from latest origin/main complete through L195; former dependencies are now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L196/audio/char-u4eae.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["亮"],
  "zhuyin": {"亮":"ㄌㄧㄤˋ"},
  "charAudio": {"亮":"/assets/lessons/L196/audio/char-u4eae.m4a"},
  "title": "亮",
  "requiredRounds": 5,
  "sentences": [
    {
