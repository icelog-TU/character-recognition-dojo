...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L203/audio/char-u9053.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["道"],
  "zhuyin": {"道":"ㄉㄠˋ"},
  "charAudio": {"道":"/assets/lessons/L203/audio/char-u9053.m4a"},
  "title": "道",
  "requiredRounds": 5,
  "sentences": [
    {
