...
- 注音：具=ㄐㄩˋ
- 目標句數：5
- 教師備註：Production A accepted teacher-approved L240 handoff. This is a release-integrated on latest origin/main after dependencies entered production complete package prepared from latest origin/main through L233 with provisional L234-L239 characters.
...
- 如果句子有數量，圖片必須清楚符合該數量。
- 優先使用明亮背景與清楚主體。
- 圖片目標路徑格式：`/assets/lessons/L240/images/L240-S01.webp`
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L240/audio/char-u5177.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
- 讀 `spokenText`，不要讀顯示標點。
- 不要把句音訊做成逐字拼接。
- 句音訊目標路徑格式：`/assets/lessons/L240/audio/L240-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L240/audio/L240-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["具"],
  "zhuyin": {"具":"ㄐㄩˋ"},
  "charAudio": {"具":"/assets/lessons/L240/audio/char-u5177.m4a"},
  "title": "具",
  "requiredRounds": 5,
  "sentences": [
    {
...
### Sentences
- L240-S01: 我在夜市買了面具。 / spokenText: 我在夜市買了面具 / focusChar: 具
- L240-S02: 球具放在球場邊。 / spokenText: 球具放在球場邊 / focusChar: 具
- L240-S03: 夜晚的市場，店家都關了。 / spokenText: 夜晚的市場店家都關了 / focusChar: 夜
- L240-S04: 這家店賣很多玩具。 / spokenText: 這家店賣很多玩具 / focusChar: 具
- L240-S05: 老師把道具放在桌上。 / spokenText: 老師把道具放在桌上 / focusChar: 具

### Stage 4
- L240-G01 find-character: L240-S04
- L240-G02 teach-character: L240-S02
- L240-G03 missing-character: L240-S01
- L240-G04 partial-order: L240-S03
- L240-G05 choose-pronunciation: L240-S05
