...
Zhuyin: 星 ㄒㄧㄥ
Title: 星
Release note: Production package request for L201 星. Release integrated from latest origin/main complete through L200 長; former lesson dependency is now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
Release note: Production package request for L201 星. Release integrated from latest origin/main complete through L200 長; former lesson dependency is now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
Provisional learned chars: 長

## Allowed Character Boundary

origin/main production JSON through L200 長 plus current target 星
