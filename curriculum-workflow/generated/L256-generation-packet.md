...
- 注音：死=ㄙˇ
- 目標句數：5
- 教師備註：Production B complete package from approved handoff. Latest origin/main production curriculum is complete through L250. L256 is blocked from production JSON until L251-L255 are in main. Treat 死 safely: no real death, bodies, funerals, horror, injury, or disaster in images.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L256/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["死"],
  "zhuyin": {"死":"ㄙˇ"},
  "charAudio": {"死":"/assets/lessons/L256/audio/char-死.m4a"},
  "title": "死",
  "requiredRounds": 5,
  "sentences": [
    {
