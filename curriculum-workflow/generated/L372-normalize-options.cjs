...
const d=JSON.parse(fs.readFileSync('curriculum-workflow/drafts/L372-draft.json','utf8'));
...
fs.writeFileSync('curriculum-workflow/generated/L372-option-volume.json',JSON.stringify(report,null,2)+'\n');console.log(report);
