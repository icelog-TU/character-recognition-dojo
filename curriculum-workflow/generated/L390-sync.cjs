// Synchronize only the owned L390 package after media/QA changes.
...
const report=JSON.parse(fs.readFileSync('curriculum-workflow/generated/L390-duration-report.json','utf8'));
...
for(const [p,data] of [[dp,d],[rp,r],['curriculum-workflow/generated/L390-duration-report.json',report]])fs.writeFileSync(p,JSON.stringify(data,null,2)+'\n');
fs.writeFileSync('curriculum-workflow/generated/L390-generation-packet.md','# L390 generation packet\n\nPackage status: '+d.packageStatus+'\n\n'+r.teacherNotes+'\n\nQA evidence: L390-package-notes.md; mechanical and format reports accompany this packet.\n\n## Approved request\n\n```json\n'+JSON.stringify(r,null,2)+'\n```\n\n## Final lesson-local draft\n\n```json\n'+JSON.stringify(d,null,2)+'\n```\n');
