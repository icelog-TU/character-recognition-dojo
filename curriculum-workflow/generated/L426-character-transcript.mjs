...
const file='public/assets/lessons/L426/audio/char-u8f2a.m4a',bytes=fs.readFileSync(file),form=new FormData();
...
fs.writeFileSync('curriculum-workflow/generated/L426-character-transcript.json',JSON.stringify(evidence,null,2)+'\n');console.log(evidence.transcript);
