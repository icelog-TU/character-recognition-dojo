...
- 注音：夜=ㄧㄝˋ
- 目標句數：5
- 教師備註：Production D complete package. Latest origin/main at handoff is complete through L233. L234-L238 are provisional dependencies; Release owns ordered production JSON insertion, planner export, ledger update, final verify, merge, and deploy.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L239/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["夜"],
  "zhuyin": {"夜":"ㄧㄝˋ"},
  "charAudio": {"夜":"/assets/lessons/L239/audio/char-夜.m4a"},
  "title": "夜",
  "requiredRounds": 5,
  "sentences": [
    {
