...
const unit=process.argv[2];if(unit!=='L410')throw Error('owned units');const folder='public/assets/lessons/'+unit+'/audio',out='curriculum-workflow/generated/'+unit+'-listening-evidence.json';
const prompt='Listen carefully to this Taiwan Mandarin recording. Give the exact Traditional Chinese transcript as heard, without an expected transcript. Report omitted or clipped syllables, actual audible syllable counts for repeated words, final syllable completeness, and awkward pauses. If 試/世/事 occurs, report actually heard pronunciation and count of repeated syllables. If 著 occurs, report whether neutral ˙ㄓㄜ or another reading was heard; do not infer only from text. If uncertain, say so. Return concise JSON. This is independent AI listening, not human QA.';
