...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L221/audio/char-u63db.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["換"],
  "zhuyin": {"換":"ㄏㄨㄢˋ"},
  "charAudio": {"換":"/assets/lessons/L221/audio/char-u63db.m4a"},
  "title": "換",
  "requiredRounds": 5,
  "sentences": [
    {
