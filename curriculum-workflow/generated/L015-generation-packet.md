...
- Teacher notes: Generated from the web next-lesson planner. Selected choice: choice-高. Approved sentences: 在高高的山下有水; 你我二人在高山上; 高高的人有大大的手; 三個高高的人在水下; 在你的手上有水. Sentence length target: 4-12 Han characters per sentence. Prefer using recent review characters from the previous five lessons: 我 一 個 人 上 山 有 三 大 的 手 小 下 二 你 水 在. Across this lesson's sentence set, include each new character from the previous three lessons at least once: 你 水 在. Use only learned characters plus the new character(s). Use each sentence's imageNotes as teacher guidance when writing imagePrompt. Production normalization: spokenText includes every displayed Han character. Generate reviewed image prompts, AI sentence audio, and production AI charTimings after teacher approval.

## Learned Character Boundary

The AI must treat this as a locked curriculum sequence.

- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在
- Current lesson new characters: 高
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高
...
- Image target path pattern: `/assets/lessons/L015/images/L015-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L015/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L015/audio/L015-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L015/audio/L015-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["高"],
  "zhuyin": {"高":"ㄍㄠ"},
  "charAudio": {"高":"/assets/lessons/L015/audio/char-高.m4a"},
  "title": "高",
  "requiredRounds": 5,
  "sentences": [
    {
