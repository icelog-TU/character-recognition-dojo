...
- Teacher notes: 由下一課規劃工具產生，選定字：孩。已核對並修正後製作：一個小孩和一隻小鳥在家；一隻小孩的手；小孩和一隻很大的鳥；一隻小鳥和很小的家；一隻很大的手上有三個小家。修正重點：第一句 spokenText 改成和畫面文字一致；第二句依圖片情境修正為「一隻小孩的手」，這裡的「隻」修飾手；第三句 focusChar 改為「孩」，因為原本的「我」不在句子裡。每句 4 到 12 個漢字。優先複習前五課較近的字：在、高、山、上、有、很、大、的、水、一、個、人、下、手、你、我、二、小、三、家、和、隻、鳥。本課整組句子需至少包含前三課新字：和、隻、鳥。正式資料、備註與配圖要求都使用臺灣繁體字。只使用已學字加上本課新字。產生審核過的配圖要求、AI 句子音檔與正式 AI 字詞時間軸。

## Learned Character Boundary

The AI must treat this as a locked curriculum sequence.

- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家 和 隻 鳥
- Current lesson new characters: 孩
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家 和 隻 鳥 孩
...
- Image target path pattern: `/assets/lessons/L021/images/L021-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L021/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L021/audio/L021-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L021/audio/L021-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["孩"],
  "zhuyin": {"孩":"ㄏㄞˊ"},
  "charAudio": {"孩":"/assets/lessons/L021/audio/char-孩.m4a"},
  "title": "孩",
  "requiredRounds": 5,
  "sentences": [
    {
