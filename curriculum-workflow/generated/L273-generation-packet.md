...
- 注音：緊=ㄐㄧㄣˇ
- 目標句數：5
- Release note: L273 was integrated on latest origin/main in playable order after R015/R016; dependencies are resolved. Production JSON, planner data, and ledger are release-owned.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L273/audio/char-u7dca.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
