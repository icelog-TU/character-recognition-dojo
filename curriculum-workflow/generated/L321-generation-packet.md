...
- 如果句子有數量，圖片必須清楚符合該數量。
- 優先使用明亮背景與清楚主體。
- 圖片目標路徑格式：`/assets/lessons/L321/images/L321-S01.webp`
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L321/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
- 讀 `spokenText`，不要讀顯示標點。
- 不要把句音訊做成逐字拼接。
- 句音訊目標路徑格式：`/assets/lessons/L321/audio/L321-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L321/audio/L321-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["西"],
  "zhuyin": {"西":"ㄒㄧ"},
  "charAudio": {"西":"/assets/lessons/L321/audio/char-西.m4a"},
  "title": "西",
  "requiredRounds": 5,
  "sentences": [
    {
...
Release integrated this package from `origin/codex/l321-complete-package` onto latest `origin/main` after L320. The package-local `dependsOnLessons` / `provisionalLearnedChars` references to L319 and L320 were cleared because L319 and L320 are already production lessons on the release base.

The final approved sentence and Stage 4 records below match `curriculum-workflow/drafts/L321-draft.json` and `curriculum-workflow/lesson-requests/L321.json`.

## Final Approved Sentences

| id | text | spokenText | focusChar | displayLines |
| --- | --- | --- | --- | --- |
| L321-S01 | 每天，太陽從西邊下山。 | 每天太陽從西邊下山 | 西 | 每天，太陽 / 從西邊下山。 |
| L321-S02 | 西邊的天空，滿是粉色雲彩。 | 西邊的天空滿是粉色雲彩 | 西 | 西邊的天空， / 滿是 / 粉色雲彩。 |
| L321-S03 | 西風吹來，樹葉變紅了。 | 西風吹來樹葉變紅了 | 西 | 西風吹來， / 樹葉變紅了。 |
| L321-S04 | 不知道哪些人能跑到最後？ | 不知道哪些人能跑到最後 | 些 | 不知道哪些人 / 能跑到最後？ |
| L321-S05 | 這些西裝，哪一套最好看？ | 這些西裝哪一套最好看 | 西 | 這些西裝， / 哪一套 / 最好看？ |

## Final Stage 4 Games

| id | type | sentenceId | targetChar | notes |
| --- | --- | --- | --- | --- |
| L321-G01 | find-character | L321-S01 | 西 | Target 西 in sentence text. |
| L321-G02 | teach-character | L321-S02 | 西 | Prefix/suffix audio uses the sentence split around the target character. |
| L321-G03 | missing-character | L321-S03 | 西 | Target 西 in sentence text. |
| L321-G04 | partial-order | L321-S04 | 些 | Missing indexes 3-4-5-6; single-Han option cards 哪 / 些 / 人 / 能. |
| L321-G05 | choose-pronunciation | L321-S05 | 西 | Correct option is the approved sentence audio; wrong options use whole-sentence audio. |
