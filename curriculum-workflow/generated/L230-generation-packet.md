...
- 注音：剩=ㄕㄥˋ
- 目標句數：5
- 教師備註：Production C asset-complete package. Latest origin/main production JSON is complete through L226. L227, L228, and L229 are provisional dependencies, so Production prepares a complete package while Release owns ordered production JSON insertion after dependencies merge.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L230/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["剩"],
  "zhuyin": {"剩":"ㄕㄥˋ"},
  "charAudio": {"剩":"/assets/lessons/L230/audio/char-剩.m4a"},
  "title": "剩",
  "requiredRounds": 5,
  "sentences": [
    {
