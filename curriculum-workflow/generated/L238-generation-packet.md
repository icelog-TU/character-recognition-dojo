...
- 注音：市=ㄕˋ
- 目標句數：5
- 教師備註：Teacher-approved Production B handoff. Build a dependency-blocked asset-complete package if L234-L237 are not yet merged. Do not release to main from Production.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L238/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["市"],
  "zhuyin": {"市":"ㄕˋ"},
  "charAudio": {"市":"/assets/lessons/L238/audio/char-市.m4a"},
  "title": "市",
  "requiredRounds": 5,
  "sentences": [
    {
