...
Final package status must be `dependency-blocked-asset-complete` until Release integrates L224-L227 first.

## Allowed Character Boundary

Allowed display characters are latest `origin/main` L001-L223 learned chars plus provisional `知認新舊` plus current target `半`.
