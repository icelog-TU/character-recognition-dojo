...
const rows=[];
for(const name of ['L426-S01','L426-S02','char-u8f2a']){
 const raw=execFileSync(ff,['-v','error','-i',`public/assets/lessons/L426/audio/${name}.m4a`,'-ar','16000','-ac','1','-f','f32le','pipe:1'],{maxBuffer:8000000});
...
fs.writeFileSync('curriculum-workflow/generated/L426-pitch-evidence.json',JSON.stringify(rows,null,2)+'\n');
...
svg+='</svg>';fs.writeFileSync('curriculum-workflow/ai-outputs/L426/pitch.svg',svg);
