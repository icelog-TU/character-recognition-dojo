...
const root=path.resolve('public/assets/lessons/L433/audio');
const report=[];
...
fs.writeFileSync('curriculum-workflow/generated/L433-silence-trim.json',JSON.stringify(report,null,2)+'\n');
console.log(report);
