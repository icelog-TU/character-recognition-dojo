...
- 注音：進=ㄐㄧㄣˋ
- 目標句數：5
- Release note: Teacher-approved final source for L207 進. Release integrated from latest origin/main complete through L206 從; earlier lesson dependencies are now satisfied on main. Use Taiwan Traditional Chinese and Taiwan zhuyin only. Images must be square 1:1 compositions using approved lesson style and cast anchors, with no text, numbers, signs, labels, logos, zhuyin, or watermarks. Audio must be standalone OpenAI charAudio, whole-sentence AI audio, independent G02 teach audio, and independent G05 wrong-choice whole-sentence audio.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L207/audio/char-u9032.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["進"],
  "zhuyin": {"進":"ㄐㄧㄣˋ"},
  "charAudio": {"進":"/assets/lessons/L207/audio/char-u9032.m4a"},
  "title": "進",
  "requiredRounds": 5,
  "sentences": [
    {
