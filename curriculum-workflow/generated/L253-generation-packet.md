...
- 注音：張=ㄓㄤ
- 目標句數：5
- 教師備註：Production C accepted L253 handoff. Origin/main currently contains production curriculum through L240 and review modules through R012; R013/R014 and L241-L252 are not in production JSON, so this package is blocked from merge until those dependencies land.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L253/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["張"],
  "zhuyin": {"張":"ㄓㄤ"},
  "charAudio": {"張":"/assets/lessons/L253/audio/char-張.m4a"},
  "title": "張",
  "requiredRounds": 5,
  "sentences": [
    {
