...
- 注音：早=ㄗㄠˇ
- 目標句數：5
- Release note: Teacher-approved final source for L208 早. Release integrated from latest origin/main complete through L207 進; earlier lesson dependencies are now satisfied on main. Use Taiwan Traditional Chinese and Taiwan zhuyin only. Images must be square 1:1 compositions using approved lesson style and cast anchors, with no text, numbers, signs, labels, logos, zhuyin, or watermarks. Audio must be standalone OpenAI charAudio, whole-sentence AI audio, independent G02 teach audio, and independent G05 wrong-choice whole-sentence audio.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L208/audio/char-u65e9.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["早"],
  "zhuyin": {"早":"ㄗㄠˇ"},
  "charAudio": {"早":"/assets/lessons/L208/audio/char-u65e9.m4a"},
  "title": "早",
  "requiredRounds": 5,
  "sentences": [
    {
