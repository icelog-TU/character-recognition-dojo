...
- 顯示名稱：複習十六
- 複習序號：16
- 接在課程：L150 後，不佔 L 課程序號。
- 覆蓋目標：L121-L150
- 目標句數：5
- 本模組必選覆蓋字：雨 雲 黑 白 棋 鞋 穿 戴 衣 脫 氣 套 熱 冷 喝 飯 菜 老 卻 麼 什 為 以 怎 所 房 間 時 還 燈
- 教師備註：Review Migration approved R015/R016 pair. R016 covers L121-L150 as part of the pair; allowed-character ceiling is L150.
...
```json
{
  ...
  "targetLessonRange": {"startOrder":121,"endOrder":150},
  "requiredCoverageChars": ["雨","雲","黑","白","棋","鞋","穿","戴","衣","脫","氣","套","熱","冷","喝","飯","菜","老","卻","麼","什","為","以","怎","所","房","間","時","還","燈"],
  "requiredRounds": 5,
  "sentences": []
}
```
