...
- 顯示名稱：複習五十八
- 複習序號：58
- 接在課程：L465 後，不佔 L 課程序號。
- 覆蓋目標：L436-L465
- 目標句數：6
- 本模組必選覆蓋字：補 修 習 練 運 賽 機 操 器 樂 音 拍 歌 唱 舞 台 候 演 表 現 突 實 其 中 午 文 日 期 待 招
- 教師備註：Updated teacher-approved handoff supersedes every older version. R058-S02 is the middle-school/elementary-school mistaken-identity scene; all archery sentence, image, audio, timing and G02 data are forbidden.
...
請為幼兒認字 App 產生6 到 7 句。句子必須自然、具體、容易配圖，並協助覆蓋上方必選字。
...
- 圖片目標路徑格式：`/assets/reviews/R058/images/R058-S01.webp`
- 句音訊目標路徑格式：`/assets/reviews/R058/audio/R058-S01.m4a`
- 複習模組沒有單字音訊。
...
```json
{
  ...
  "reviewNumber": 58,
  "title": "複習五十八",
  "afterLessonOrder": 465,
  "targetLessonRange": {"startOrder":436,"endOrder":465},
  "requiredCoverageChars": ["補","修","習","練","運","賽","機","操","器","樂","音","拍","歌","唱","舞","台","候","演","表","現","突","實","其","中","午","文","日","期","待","招"],
  "requiredRounds": 6,
  "sentences": []
}
```
