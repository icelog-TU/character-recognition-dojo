...
- Teacher notes: Generated from the web next-lesson planner. Selected choice: choice-家. Approved sentences: 你的家在高山下; 我的家在高山上; 山上有三個很大的家; 你我二人在家; 有一個很小的家在水上. Sentence length target: 4-12 Han characters per sentence. Prefer using recent review characters from the previous five lessons: 你 一 個 人 上 山 下 手 有 三 小 我 大 二 的 水 在 高 很. Across this lesson's sentence set, include each new character from the previous three lessons at least once: 在 高 很. Use only learned characters plus the new character(s). Use each sentence's imageNotes as teacher guidance when writing imagePrompt. Generate reviewed image prompts, AI sentence audio, and production AI charTimings after teacher approval. spokenText has been production-normalized by Codex to match the visible Han text with punctuation removed.

## Learned Character Boundary

The AI must treat this as a locked curriculum sequence.

- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很
- Current lesson new characters: 家
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家
...
- Image target path pattern: `/assets/lessons/L017/images/L017-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L017/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L017/audio/L017-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L017/audio/L017-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["家"],
  "zhuyin": {"家":"ㄐㄧㄚ"},
  "charAudio": {"家":"/assets/lessons/L017/audio/char-家.m4a"},
  "title": "家",
  "requiredRounds": 5,
  "sentences": [
    {
