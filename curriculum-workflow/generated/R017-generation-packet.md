...
- 教師備註：Teacher-approved review module package after L300. Review modules introduce no newChars, zhuyin, or charAudio. Production confirmed origin/main already includes L298-L300, so no provisional learned chars are needed for the allowed-character sweep. R017 covers: 工, 作, 忙, 幫, 急, 腳, 步, 跳, 床, 搬, 重, 沙, 張, 椅, 累. R017/R018 pair covers L241-L270 exactly once or more across the pair.
...
- 圖片目標路徑格式：`/assets/reviews/R017/images/R017-S01.webp`
- 句音訊目標路徑格式：`/assets/reviews/R017/audio/R017-S01.m4a`
- 複習模組沒有單字音訊。
