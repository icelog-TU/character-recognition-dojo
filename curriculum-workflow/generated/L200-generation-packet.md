...
- 注音：長=ㄔㄤˊ／ㄓㄤˇ
- 目標句數：5
- Release note: Production package request for L200 長. Release integrated from latest origin/main complete through L199 影; former lesson dependency is now satisfied on main. Approved final sentences, Stage 4 plan, image rules, and audio rules are from the teacher handoff.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L200/audio/char-u9577.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["長"],
  "zhuyin": {"長":"ㄔㄤˊ／ㄓㄤˇ"},
  "charAudio": {"長":"/assets/lessons/L200/audio/char-u9577.m4a"},
  "title": "長",
  "requiredRounds": 5,
  "sentences": [
    {
