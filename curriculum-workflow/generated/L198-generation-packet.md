...
- 注音：月=ㄩㄝˋ
- 目標句數：5
- 教師備註：Teacher-approved final source for L198 月. Latest origin/main is complete through L195 光; L196 亮 and L197 陽 are provisional dependencies unless already merged by Release. Use Taiwan Traditional Chinese and Taiwan zhuyin only. Images must be square 1:1 compositions using L058 style anchors, with no text, numbers, signs, letters, zhuyin, labels, logos, or watermarks. Audio must be standalone OpenAI charAudio, whole-sentence AI audio, independent G02 suffix from exact fragment, and independent G05 wrong-choice whole-sentence audio.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L198/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["月"],
  "zhuyin": {"月":"ㄩㄝˋ"},
  "charAudio": {"月":"/assets/lessons/L198/audio/char-月.m4a"},
  "title": "月",
  "requiredRounds": 5,
  "sentences": [
    {
