...
- 注音：像=ㄒㄧㄤˋ
- 目標句數：5
- 教師備註：Production B complete package for L185. Latest origin/main production JSON is complete through L182 師, so L185 depends on L183 話 and L184 課. Use only latest production learned characters plus provisional 話, 課 and current target 像. Approved sentences are fixed by handoff; do not introduce unlearned display text such as 長、真、圖、館、片、教、班、對、請、講、電、想、情、服、完、乾、淨、忙、急、進、步、才、剛、弄、修、丟、收、拾.
