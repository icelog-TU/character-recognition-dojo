...
- 注音：搬=ㄅㄢ
- 目標句數：5
- 教師備註：Teacher-approved L250 sentence set. Production D prepares a complete lesson-local asset-complete-package. This branch is dependency/review blocked until R013/R014 and L241-L249 are merged into latest origin/main.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L250/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["搬"],
  "zhuyin": {"搬":"ㄅㄢ"},
  "charAudio": {"搬":"/assets/lessons/L250/audio/char-搬.m4a"},
  "title": "搬",
  "requiredRounds": 5,
  "sentences": [
    {
