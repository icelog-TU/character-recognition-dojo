...
const root=path.resolve('public/assets/lessons/L421/audio');
const report=[];
for(const name of fs.readdirSync(root).filter(n=>n.endsWith('.m4a')&&!n.startsWith('char-'))){
 ...
 const threshold=name==='L421-G02-prefix.m4a'?-40:-45;
...
fs.writeFileSync('curriculum-workflow/generated/L421-silence-trim.json',JSON.stringify(report,null,2)+'\n');
console.log(report);
