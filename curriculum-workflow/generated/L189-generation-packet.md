...
Latest origin/main production JSON is complete through L188 力, so dependencies are satisfied and there are no provisional learned characters.

Final package status is release-ready after Release re-audit on latest origin/main.

## Allowed character audit

Boundary: L001-L188 learned chars from latest origin/main + current 能.
