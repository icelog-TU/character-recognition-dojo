...
- 注音：右=ㄧㄡˋ
- 目標句數：5
- 教師備註：Production A complete-package handoff for L329. Latest origin/main at claim is 30f18b5e Integrate lesson L327; L328 轉 is not merged and is treated as a provisional dependency. Approved sentences are fixed; do not change text. Release owns final ordered integration after L328 is in main.
...
- 如果句子有數量，圖片必須清楚符合該數量。
- 優先使用明亮背景與清楚主體。
- 圖片目標路徑格式：`/assets/lessons/L329/images/L329-S01.webp`
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L329/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
- 讀 `spokenText`，不要讀顯示標點。
- 不要把句音訊做成逐字拼接。
- 句音訊目標路徑格式：`/assets/lessons/L329/audio/L329-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L329/audio/L329-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["右"],
  "zhuyin": {"右":"ㄧㄡˋ"},
  "charAudio": {"右":"/assets/lessons/L329/audio/char-右.m4a"},
  "title": "右",
  "requiredRounds": 5,
  "sentences": [
    {
  ...
  "approvedSentences": [
    {
      ...
      "hanCount": 9,
      "imageNotes": "主角小女孩坐在桌前，右手拿筆，在紙上畫一條橫向直線；線從紙的左側延伸到右側。不要使用箭頭、文字、符號或圖解標記。"
    },
    {
      "id": "L329-S02",
      "text": "先向左轉，再向右轉。",
      ...
      "hanCount": 8,
      "imageNotes": "主角小女孩和同學在做體操，老師在前面帶動作；孩子們正在轉身做左右轉的動作，畫面自然呈現體操課。不要使用箭頭、文字、符號或動作說明標記。"
    },
    {
      "id": "L329-S03",
      "text": "過馬路時，要左看右看。",
      "spokenText": "過馬路時要左看右看",
      "focusChar": "右",
      "displayLines": [
        "過馬路時，",
        "要左看右看。"
      ...
      "hanCount": 9,
      "imageNotes": "主角小女孩和媽媽站在人行道邊，準備過馬路；小女孩轉頭看路上的車，媽媽在旁邊陪著。車輛距離安全，畫面不要危險驚嚇。"
    },
    {
      "id": "L329-S04",
      "text": "三點左右，要去同學家玩。",
      ...
      "hanCount": 10,
      "imageNotes": "家裡牆上時鐘接近三點，主角小女孩背著小包站在門口，媽媽在旁邊送她出門，情境是準備去同學家玩。時鐘可見但不要出現可讀文字或數字以外的額外標記。"
    },
    {
      "id": "L329-S05",
      "text": "爸爸一直在地圖上畫線。",
      "spokenText": "爸爸一直在地圖上畫線",
      "focusChar": "線",
      "displayLines": [
        "爸爸一直",
        "在地圖上",
      ...
      "hanCount": 10,
      "imageNotes": "主角爸爸坐在桌前看地圖，手上拿筆在地圖上畫路線；主角小女孩在旁邊看。地圖可以有簡單道路線條，但不要有可讀文字、地名、箭頭或符號。"
    }
  ],
  "sentenceGames": [
    {
    ...
    },
    {
      ...
      "teachAudio": {
        "prefixText": "先向左轉再向",
        "suffixText": "轉",
        "prefixSrc": "/assets/lessons/L329/audio/L329-G02-prefix.m4a",
        "suffixSrc": "/assets/lessons/L329/audio/L329-G02-suffix.m4a"
      }
    },
    {
      "id": "L329-G03",
