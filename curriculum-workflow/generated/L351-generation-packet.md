...
- New character: 餐
- Zhuyin: ㄘㄢ
- Source boundary: origin/main f9714d19; production JSON includes L001-L348, latest formal character 客.
- Dependencies: L349「讓」 and L350「廳」 are not in latest origin/main at Production start.
- Provisional learned chars: 讓, 廳.
...
`json
{
  ...
  "requiredRounds": 5,
  "originHint": "Built from origin/main f9714d19 through L348. L349「讓」 and L350「廳」 are provisional dependencies; Release owns production JSON insertion, planner export, ledger update, registry cleanup, final verify, push, and deployment.",
  "sentences": [
    {
      "id": "L351-S01",
      "text": "這家餐廳好吃，我們是常客。",
...
`json
{
  ...
  "teacherNotes": "Teacher-approved Production A handoff for L351. Latest origin/main boundary at production start is f9714d19 with formal production lessons L001-L348, latest formal new character 客. L349「讓」 and L350「廳」 are not in latest origin/main at production start, so L351 records them as provisional dependencies. Production builds a lesson-local dependency-blocked asset-complete package; Release owns ordered integration into production JSON, planner, ledger, registry cleanup, final verify, push, and deployment.",
  "dependsOnLessons": [
    "L349",
    "L350"
  ],
  ...
  "generationConstraints": {
    "allowedDisplayCharsBoundary": "formal learned chars through latest origin/main production JSON L348 plus provisional L349「讓」 and L350「廳」 plus current new char L351「餐」",
