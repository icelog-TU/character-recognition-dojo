...
const root='public/assets/lessons/L408/audio',report=[];
...
fs.writeFileSync('curriculum-workflow/generated/L408-tail-trim-report.json',JSON.stringify(report,null,2)+'\n');console.log(report);
