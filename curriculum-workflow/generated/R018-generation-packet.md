...
- 顯示名稱：複習十八
- 複習序號：18
- 接在課程：L300 後，不佔 L 課程序號。
- 覆蓋目標：L241-L270
- 目標句數：5
- 本模組必選覆蓋字：工 作 忙 幫 急 腳 步 跳 床 搬 重 沙 張 椅 累 死 睡 倒 病 假 才 剛 裝 養 休 息 久 體 神 精
- 教師備註：Teacher-approved review module package after L300. Review modules introduce no newChars, zhuyin, or charAudio. Production confirmed origin/main already includes L298-L300, so no provisional learned chars are needed for the allowed-character sweep. R018 covers: 死, 睡, 倒, 病, 假, 才, 剛, 裝, 養, 休, 息, 久, 體, 神, 精. R017/R018 pair covers L241-L270 exactly once or more across the pair.
...
- 圖片目標路徑格式：`/assets/reviews/R018/images/R018-S01.webp`
- 句音訊目標路徑格式：`/assets/reviews/R018/audio/R018-S01.m4a`
- 複習模組沒有單字音訊。
