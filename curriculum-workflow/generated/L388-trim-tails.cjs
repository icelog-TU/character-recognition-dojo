...
const root='public/assets/lessons/L388/audio',report=[];
...
fs.writeFileSync('curriculum-workflow/generated/L388-tail-trim-report.json',JSON.stringify(report,null,2)+'\n');console.log(report);
