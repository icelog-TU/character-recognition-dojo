...
const folder = "public/assets/lessons/L415/audio", out = "curriculum-workflow/generated/L415-listening-evidence.json";
const prompt = "Listen to this Mandarin audio. Transcribe verbatim Traditional Chinese. Report any omitted or added syllables, clipped final syllable, unnatural pauses. If liao/le, zhang/chang, zhe, or jie occurs, report the ACTUALLY HEARD tone and contour, not a tone inferred only from spelling; say uncertain if unreliable. Return concise JSON with transcript, toneObservations, finalSyllableComplete, defects, confidence. No expected transcript is provided.";
