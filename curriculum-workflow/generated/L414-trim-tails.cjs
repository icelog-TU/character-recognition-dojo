...
const root='public/assets/lessons/L414/audio',report=[];
...
fs.writeFileSync('curriculum-workflow/generated/L414-tail-trim-report.json',JSON.stringify(report,null,2)+'\n');console.log(report);
