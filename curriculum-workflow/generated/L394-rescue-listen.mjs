...
for(const file of fs.readdirSync(folder).filter(f=>f.endsWith('.m4a'))){
 ...
 if(process.argv[2] && file!==process.argv[2])continue; if(!process.argv[2] && rows.some(r=>r.file===file&&r.sha256===sha256))continue;
