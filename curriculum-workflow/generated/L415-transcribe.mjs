...
const root = "public/assets/lessons/L415/audio", rows = [];
for (const file of fs.readdirSync(root).filter(f => f.endsWith(".m4a"))) {
  ...
  fs.writeFileSync("curriculum-workflow/generated/L415-transcript-evidence.json",JSON.stringify(rows,null,2)+"\n");
