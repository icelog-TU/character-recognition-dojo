...
- 注音：變=ㄅㄧㄢˋ
- 目標句數：5
- Release note: L271 was integrated on latest origin/main in playable order after R015/R016; dependencies are resolved. Production JSON, planner data, and ledger are release-owned.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L271/audio/char-u8b8a.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
