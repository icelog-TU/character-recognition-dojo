...
- 注音：場=ㄔㄤˇ
- 目標句數：5
- 教師備註：Teacher-approved L237 Production C handoff. Origin/main is complete through L233 at claim time, so L234 貴, L235 賣, and L236 店 are provisional dependencies. Prepare a complete package but keep production JSON out of final branch until dependencies are merged.
...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L237/audio/char-字.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["場"],
  "zhuyin": {"場":"ㄔㄤˇ"},
  "charAudio": {"場":"/assets/lessons/L237/audio/char-場.m4a"},
  "title": "場",
  "requiredRounds": 5,
  "sentences": [
    {
