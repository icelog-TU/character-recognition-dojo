...
const root = path.resolve('public/assets/lessons/L463/audio');
const report = [];
...
fs.writeFileSync('curriculum-workflow/generated/L463-silence-trim.json', `${JSON.stringify(report, null, 2)}\n`);
console.log(report);
