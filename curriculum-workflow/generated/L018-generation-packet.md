...
- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家
- Current lesson new characters: 和
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家 和
...
- Image target path pattern: `/assets/lessons/L018/images/L018-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L018/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L018/audio/L018-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L018/audio/L018-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
