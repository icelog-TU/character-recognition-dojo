...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L220/audio/char-u8932.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["褲"],
  "zhuyin": {"褲":"ㄎㄨˋ"},
  "charAudio": {"褲":"/assets/lessons/L220/audio/char-u8932.m4a"},
  "title": "褲",
  "requiredRounds": 5,
  "sentences": [
    {
