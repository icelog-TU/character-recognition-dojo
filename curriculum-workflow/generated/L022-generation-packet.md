...
- Teacher notes: Generated from the web next-lesson planner. Selected choice: choice-指. Approved sentences: 小孩的一隻手指; 三隻小鳥和手指山; 很大的手指上有一隻小鳥; 小孩和小鳥在家; 小孩和在水上的家. Sentence length target: 4-12 Han characters per sentence. Prefer using recent review characters from the previous five lessons: 你 的 家 在 高 山 下 我 上 有 三 個 很 大 二 人 一 小 水 和 手 隻 鳥 孩. Across this lesson's sentence set, include each new character from the previous three lessons at least once: 隻 鳥 孩. Use only learned characters plus the new character(s). Use each sentence's imageNotes as teacher guidance when writing imagePrompt. Generate reviewed image prompts, AI sentence audio, and production AI charTimings after teacher approval.

## Learned Character Boundary

The AI must treat this as a locked curriculum sequence.

- Previously learned characters: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家 和 隻 鳥 孩
- Current lesson new characters: 指
- Allowed Han characters for display text: 一 二 三 人 個 大 的 小 手 我 有 山 上 下 你 水 在 高 很 家 和 隻 鳥 孩 指
...
- Image target path pattern: `/assets/lessons/L022/images/L022-S01.webp`
...
- Character audio target path pattern: `/assets/lessons/L022/audio/char-字.m4a`
- Voice: natural Taiwan Mandarin.
- Read `spokenText`, not display punctuation.
- Do not synthesize character by character.
- Audio target path pattern: `/assets/lessons/L022/audio/L022-S01.m4a`
...
```json
{
  "src": "/assets/lessons/L022/audio/L022-S01.m4a",
  "durationMs": 1200,
  "charTimings": [
...
```json
{
  ...
  "newChars": ["指"],
  "zhuyin": {"指":"ㄓˇ"},
  "charAudio": {"指":"/assets/lessons/L022/audio/char-指.m4a"},
  "title": "指",
  "requiredRounds": 5,
  "sentences": [
    {
