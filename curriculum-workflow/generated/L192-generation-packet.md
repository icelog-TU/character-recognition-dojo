...
Latest origin/main production JSON is complete through L191 發, so dependencies are satisfied and no provisional learned characters are needed.
...
Boundary: L001-L191 learned chars from latest origin/main + current 電.
