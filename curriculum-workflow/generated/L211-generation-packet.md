...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L211/audio/char-u8239.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["船"],
  "zhuyin": {"船":"ㄔㄨㄢˊ"},
  "charAudio": {"船":"/assets/lessons/L211/audio/char-u8239.m4a"},
  "title": "船",
  "requiredRounds": 5,
  "sentences": [
    {
