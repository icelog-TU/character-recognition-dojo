...
- 本課每個新字都要建立一個單字音訊。
- 單字音訊目標路徑格式：`/assets/lessons/L222/audio/char-u6539.m4a`
- 聲音：自然、清楚、適合幼兒的臺灣華語。
...
```json
{
  ...
  "newChars": ["改"],
  "zhuyin": {"改":"ㄍㄞˇ"},
  "charAudio": {"改":"/assets/lessons/L222/audio/char-u6539.m4a"},
  "title": "改",
  "requiredRounds": 5,
  "sentences": [
    {
